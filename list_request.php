...
$tb_request = $requestItem->tableRoomReuqested();
								...
								<thead class="btn-info">
                                    ...
                                    <tbody>
									 <?PHP
										...
										<td><a href="check_aproval.php?request_id=<?php echo "$mt_id"; ?>"  class="btn btn-outline-info btn-rounded"  class="btn btn-outline-info btn-rounded"><i class="fa fa-eye"></i> ສະແດງ </a></td>
